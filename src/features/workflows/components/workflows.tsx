...
import {EntityList, EntityListItem} from "@/components/entity-components";
...
import { useSuspenseWorkflow , useRemoveWorkflow} from "../hooks/use-workflow";
...
export const WorkflowsList = () => {
    ...
    return (
        <EntityList
            ...
            renderItem={(workflow)=>(
                <WorkflowListItem data={workflow}/>
            )}
