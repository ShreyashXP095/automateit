...
// here entity refers to workflows / credentials / executions all would use this reusable compoenet
...
export const LoadingView = ({
    ...
    return (
        <div className="flex items-center justify-center h-full flex-1 flex-col gap-y-4">
            ...
            {/* !!message is same as Boolean(message)*/}
        </div>
    )
}
...
interface EmptyViewProps extends StateViewProps{
    onNew? : () => void; // ? means its optional prop   
}
